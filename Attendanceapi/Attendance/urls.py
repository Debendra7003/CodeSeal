...
from Attendance.views import UserRegisterView,UserLoginView,UserProfileView,UserPasswordChangeView,EmployeeRegisterView,EmployeeDeleteview,EmployeeSearchView,SendOTPView,ResetPasswordView,EmployeeAttendanceAPIView,LogoutView
